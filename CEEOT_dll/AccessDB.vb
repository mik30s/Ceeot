...
Public Module AccessDB
    Private sDBConnectionDefault As String = "PROVIDER=Microsoft.Jet.OLEDB.4.0;Data Source= " & Initial.Dir1 & "\Project_Parameters.mdb;"
    ...
    Public Function getDBDataTable(query As String) As Data.DataTable
        Dim dsBas As New Data.DataSet()
        Dim myConnection As New OleDb.OleDbConnection
        Dim myConnection1 As New OleDb.OleDbConnection
        Dim myConnection2 As New OleDb.OleDbConnection()
